...
app = Client(
    "773593833:AAHN3pzwdWAdX9ce8wlV2QnZee-24TCRZZ4",
    api_id=api_id,
    api_hash=api_hash)
...
def messages(bot, update):
        ...
        if user_chat is None:
            bot.send_message(chat_id=update.from_user.id,text="**INVALID ACTION:** 😩 Kindly send /start or /reset to initiate your session", parse_mode="Markdown")
            return
